...
- (`#80 <https://github.com/znicholls/silicone/pull/80>`_) Changed the names of crunchers for brevity. Changed ``lead_gas`` to ``latest_time_ratio`` and gave it documentation.
