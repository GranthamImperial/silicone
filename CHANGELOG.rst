...
- (`#82 <https://github.com/znicholls/silicone/pull/82>`_) Updated to a later version of pyam and solved todos associated with this. Also added a ``cruncher_kwargs`` argument to infill_all_required.
