...
master
------
-(`#42 <https://github.com/znicholls/silicone/pull/42>`_) Added convenient wrappers for the crunchers and introduced utilities that check for consistent summation of variables.
