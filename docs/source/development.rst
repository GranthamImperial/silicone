...
Normally, the fastest way to solve an issue is to contact us via the `issue tracker <https://github.com/GranthamImperial/silicone/issues>`_.
...
.. _Silicone issue tracker: https://github.com/GranthamImperial/silicone/issues
