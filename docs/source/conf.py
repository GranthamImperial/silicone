...
latex_documents = [
    (master_doc, "silicone.tex", "Silicone Documentation", author, "manual")
]
...
man_pages = [(master_doc, "silicone", "Silicone Documentation", [author], 1)]
